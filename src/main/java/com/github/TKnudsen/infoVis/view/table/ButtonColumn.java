...
//		if (row % 2 == 0)
//			renderButton.setBackground(NimbusUITools.standardBackgroundColor.brighter().brighter());
//		else
//			renderButton.setBackground(NimbusUITools.standardBackgroundColor.brighter());
