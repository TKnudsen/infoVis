package com.github.TKnudsen.infoVis.view.visualChannels.color.colormaps.quantitative.impl.bipolar;
...
/**
 * <p>
 * Defined by a negative, a neutral, and a positive value.
 * </p>
 *
 * @version 1.01
 */
public class BipolarParameterizableColorMap extends AbstractColorMap1D {

	protected static AbstractColorMap instance;

	protected BipolarParameterizableColorMap() {
		super();
	}

	public BipolarParameterizableColorMap(Color negativeColor, Color neutralColor, Color positiveColor) {
		super();

		setColors(negativeColor, neutralColor, positiveColor);
	}
	...
	public String toString() {
		return "Parameterizable bipolar colormap";
	}
	...
	public static synchronized AbstractColorMap getInstance() {
		if (instance == null) {
			instance = new BipolarParameterizableColorMap();
		}
		return instance;
	}
	...
	public void setColors(Color negativeColor, Color neutralColor, Color positiveColor) {

		colors = new Color[] { negativeColor, neutralColor, positiveColor };
	}
}
