...
class AutoTextField<E> extends JTextField {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7780382701346205824L;
	...
	private AutoCompleteComboBox<E> autoComboBox;
	...
	class AutoDocument extends PlainDocument {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -2233082262203557380L;
	...
	AutoTextField(List<E> list, AutoCompleteComboBox<E> b) {
		isCaseSensitive = false;
		isStrict = true;
		autoComboBox = null;
		if (list == null) {
