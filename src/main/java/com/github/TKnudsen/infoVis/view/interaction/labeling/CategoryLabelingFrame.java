...
/**
 * <p>
 * Interactive dialog for assigning a category label to a raw input string,
 * with optional automatic guessing and ChatGPT-assisted suggestions.
 * Countdown, pause, and timeout are handled by a background
 * {@link SwingWorker}.
 * </p>
 *
 * @version 1.0
...
public class CategoryLabelingFrame extends SVGFrame {
	 ...
	 *                                   probabilities
	 */
	public CategoryLabelingFrame(String category, Set<String> labelAlphabet,
