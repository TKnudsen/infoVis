 ...
 * @since 2017
 */
public class DarkGrayToPurpleColorMap extends AbstractColorMap1D {

	protected static AbstractColorMap instance;

	protected DarkGrayToPurpleColorMap() {
		super();
	}
	...
	protected void setColors() {
		colors = new Color[] { Color.GRAY, new Color(200, 60, 180) };
	}
	...
	public static synchronized AbstractColorMap getInstance() {
		if (instance == null) {
			instance = new DarkGrayToPurpleColorMap();
		}
		return instance;
	}
