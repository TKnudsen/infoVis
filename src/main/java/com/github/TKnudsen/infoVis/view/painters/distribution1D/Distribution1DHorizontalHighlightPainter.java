 ...
 * @version 1.03
 */
public class Distribution1DHorizontalHighlightPainter extends Distribution1DHorizontalPainter {
	...
	public Distribution1DHorizontalHighlightPainter(Collection<Double> values) {
		super(values);
	}
