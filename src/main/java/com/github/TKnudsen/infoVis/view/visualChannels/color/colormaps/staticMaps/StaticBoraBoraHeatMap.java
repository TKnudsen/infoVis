...
/**
 * <p>
 * Mimics the ocean and beach colors of Bora Bora, the island that inspired this
 * colormap.
 * </p>
 *
 * @version 1.0
 * @since 2009
 */
public class StaticBoraBoraHeatMap {

	private static final Color colors[] = { new Color(0, 77, 102), new Color(1, 77, 102), new Color(2, 78, 103),
	...
	public static void drawColormap(Rectangle2D rect, Graphics2D g, float alpha, String label1, String label2) {
		...
		// draw legend
		if (label1 != null)
			g.drawString(label1, (int) rect.getMinX() + 5, (int) rect.getMinY() + 12);
		if (label2 != null)
			g.drawString(label2, (int) rect.getMaxX() - 30, (int) rect.getMinY() + 12);
	}
}
