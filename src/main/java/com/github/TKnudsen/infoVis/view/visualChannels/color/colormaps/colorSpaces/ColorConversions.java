...
{ 
            ...
            double Z)
    {
        ...
        double var_X = X / ref_X; //ref_X =  95.047  Observer= 2 degrees, Illuminant= D65
    ...
    public static final ColorXYZ convertCIELabtoXYZ(double L, double a, double b)
    {
        ...
        double X = ref_X * var_X; //ref_X =  95.047  Observer= 2 degrees, Illuminant= D65
...
//                Debug.debug("uh oh");
    ...
    public static final int convertCIELabtoARGBTest(int cieL, int cieA, int cieB)
    {
 ...
 
        {
            ...
            X = ref_X * var_X; //ref_X =  95.047  Observer= 2 degrees, Illuminant= D65
    ...
    public static ColorCIELuv convertXYZtoCIELuv(double X, double Y, double Z)
    {
        ...
        double ref_X = 95.047; //Observer= 2 degrees, Illuminant= D65
        double ref_Y = 100.000;
        double ref_Z = 108.883;
