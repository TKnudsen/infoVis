...
/**
 * @version 1.02 BlueRedColorMap() Constructor added (2012-01-10)
 * @since 2011-11-03
 */
public class BlueRedColorMap extends AbstractColorMap1D {
	protected static AbstractColorMap instance;

	protected BlueRedColorMap() {
		super();
	}

	@Override
	public ColorMap1DEnum getColorMapType() {
		return ColorMap1DEnum.BIPOLAR_BlueRed;
	}
