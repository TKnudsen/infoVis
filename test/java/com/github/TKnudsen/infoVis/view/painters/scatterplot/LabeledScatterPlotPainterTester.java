 ...
 * @version 1.01
 */
public class LabeledScatterPlotPainterTester {
	...
	public static void main(String[] args) {
		...
		LabeledScatterplotPainter painter = new LabeledScatterplotPainter(points, colors, labels);

		SVGFrameTools.dropSVGFrame(painter, "LabeledScatterplotPainter Test", 800, 800);

		System.err.println(
				"LabeledScatterPlotPainterTester: use a panel variant when interaction is relevant (see e.g., InfoVisScatterPlotChartPanelTester.java)");
	}
